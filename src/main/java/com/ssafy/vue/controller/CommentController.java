...
public class CommentController {
    ...
    @ApiOperation(value = "게시글번호에 해당하 댓글의 정보를 반환한다.", response = List.class)
	@GetMapping("{boardno}")
	public ResponseEntity<List<Comment>> selectCommentByBoardno(@PathVariable int boardno) throws Exception {
		logger.debug("selectCommentByBoardno - 호출");
		return new ResponseEntity<List<Comment>>(commentService.selectCommentByBoardno(boardno), HttpStatus.OK);
	}
	...
	@PutMapping("{no}")
	public ResponseEntity<String> updateComment(@PathVariable int no, @RequestBody Comment comment) {
